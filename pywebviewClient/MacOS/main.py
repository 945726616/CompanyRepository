...
window = webview.create_window('Vimtag', 'http://45.120.103.36:7080/dcm/version/repo/website/pkg-website-v10.6.2.2306301605/index.html?m=vimtag', js_api=api, width=webview.screens[0].width, height=webview.screens[0].height)
