        ...
        <div id='scene_page_box'>
            ...
            <div id='attachmen_box_main'>
                    ...
                    <div class='attachmen_set_list'>
                        ...
                        <div id='attachmen_door_day'>
                            ...
                            <div class='options_float_right' style='width:500px;'>
                                ...
                                <input type='range' id='input_threshold' v-model='input_threshold' min='0' max='100' ref='threshold' :title='input_threshold' />
                            </div>
                        </div>
                        <div id='attachmen_door_night'>
                            ...
                            <div class='options_float_right' style='width:500px;'>
                                ...
                                <input type='range' id='input_thresholdLevelNight' v-model='input_thresholdLevelNight' min='0' max='100' ref='thresholdLevelNight' :title='input_thresholdLevelNight' />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id='attachmen_info' v-else-if='setScenePageObj.detailPageFlag === "faceDetectPage"'>
                    ...
                    <div class='attachmen_set_list'>
                        <div class='menu_switch' id='face_detection_switch_box' style='height: 4.4rem; width: 100%;background-color: #fff;margin-top: 10px'>
                            <div class='list_name' id='face_detection_switch' style='float: left;height: 4.4rem;line-height: 4.4rem;'> {{mrs_face_detection_switch}} </div>
                            <switch-button v-model='face_detection_switch_sign' @data_updata_event='face_detection_switch_updata'></switch-button>
                        </div>
                        <div class='menu_switch' id='face_detection_frame_box' style='height: 4.4rem; width: 100%;background-color: #fff;'>
                ...
                <div id='attachmen_info' v-else-if='setScenePageObj.detailPageFlag === "soundDetectPage"'>
                    ...
                    <div class='attachmen_set_list'>
                        <div class='menu_switch' id='sound_detection_switch_box' style='height: 4.4rem; width: 100%;background-color: #fff;margin-top: 30px'>
                            <div class='list_name' id='menu_sound_switch' style='float: left;height: 4.4rem;line-height: 4.4rem;'> {{mrs_sound_detection_switch}} </div>
