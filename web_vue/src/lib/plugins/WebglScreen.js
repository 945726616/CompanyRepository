...
class WebglScreen {
  constructor(canvas) {
    // console.log(canvas, 'constructor_canvas')
    this.canvas = canvas;
    this.gl =
      canvas.getContext('webgl') ||
      canvas.getContext('experimental-webgl');
    // console.log(this.gl, 'constructor_gl')
    this._init();
  }

  _init () {
    let gl = this.gl;
    // console.log(this, 'init打印gl')
    // console.log(this.gl, 'init打印this.gl')
    if (!gl) {
  ...
  renderImg (width, height, data) {
    // console.log(width, height, '在webgl类中打印')
    let gl = this.gl;
    // console.log(gl, '打印gl内容')
